...
# 合并每日基本信息
merge_basic_daily = pd.merge( basic, daily, on='ts_code', sort=False,
...
ht_merge_basic_daily = merge_basic_daily[['ts_code', 'close_x', 'float_share', 'total_share', 'circ_mv', 'total_mv']]
